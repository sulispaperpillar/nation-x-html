...
Nation X website build with HTML using Pug and Sass.
...
* Navigate to the directory where your project folder is located using **Terminal**.
* Execute `npm install`.
...
* Put all HTML files and assets into public_html folder on your hosting server.